...
@Component({
  selector: 'app-officerupdatest',
  templateUrl: './officerupdatest.component.html',
  styleUrls: ['./officerupdatest.component.css']
})
export class OfficerupdatestComponent implements OnInit {
