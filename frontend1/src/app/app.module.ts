...
import { TraineraddstComponent } from './components/traineraddst/traineraddst.component';
import { OfficerupdatestComponent } from './components/officerupdatest/officerupdatest.component';
import { LandingofficerComponent } from './components/landingofficer/landingofficer.component';
...
@NgModule({
  declarations: [
    ...
    TraineraddstComponent,
    OfficerupdatestComponent,
    LandingofficerComponent
